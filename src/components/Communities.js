    ...
    return (
      <div className="">
        ...
        <div>
				...
				<div>
					<div className="h-[360px] w-[640px] bg-center bg-no-repeat bg-cover"
					     style={{backgroundImage: 'url(https://media.kommunity.com/communities/devops-turkiye/events/exploring-keyless-codesigning-with-spiffe-vault-5750c3fa/42924/2.png?p=event-640)'}}></div>
				</div>
                <div>
					<div className="h-[360px] w-[640px] bg-center bg-no-repeat bg-cover"
